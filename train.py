...
def main(args):
    ...
    global best_bleu4, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, word_map, lowest_loss
    ...
    for epoch in range(start_epoch, epochs):
        ...
        is_lowest = recent_loss < lowest_loss
        lowest_loss = min(lowest_loss, recent_loss)
        ...
        save_checkpoint(data_name, epoch, epochs_since_improvement, encoder, decoder, encoder_optimizer,
                        decoder_optimizer, recent_bleu4, recent_loss, is_best, is_lowest)
